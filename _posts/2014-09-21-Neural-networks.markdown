...
tags:
  ...
  - neural networks
---
在Coursera修的[机器学习](https://class.coursera.org/ml-006)已经结束了，感觉很多学完大概明白了各个算法大概干什么的，但是推导成功只能理解的模模糊糊，数学基础还是差太多。
...
\end{align}
将上式中的\textstyle n_l-1与\textstyle n_l的关系替换为\textstyle l与\textstyle l+1的关系，就可以得到：
...
那么，反向传播算法可表示为以下几个步骤：
进行前馈传导计算，利用前向传导公式，得到 \textstyle L_2, L_3, \ldots直到输出层 \textstyle L_{n_l} 的激活值。
...
[https://github.com/liuli1735/machine-learning-coursera/tree/master/problem_sets/ex4_solution](https://github.com/liuli1735/machine-learning-coursera/tree/master/problem_sets/ex4_solution)

更详细的基础推导可见UFLDL中[“反向传导算法”](http://deeplearning.stanford.edu/wiki/index.php/%E5%8F%8D%E5%90%91%E4%BC%A0%E5%AF%BC%E7%AE%97%E6%B3%95)

更加复杂的卷积神经网络的算法推导还没具体去看，附带一个别人写的[CNN卷积神经网络推导和实现](http://blog.csdn.net/zouxy09/article/details/9993371)
